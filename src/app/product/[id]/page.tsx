...
// MOCK REVIEWS DATABASE (MAMA CASS ONLY)
...
const ALL_PRODUCTS: Record<string, {
  ...
  f5: {
    ...
    details: ["Nutritious Melon Seed Soup", "Tender Beef Chunks", "Smooth Pounded Yam Wrap"],
    prepTime: "15-20 mins",
    isAvailable: true,
    category: "food",
    rating: 4.9,
  ...
  p1_4: {
    ...
    details: ["Double Chicken Portions", "Firewood Party Smoky Flavor", "Includes Dodo & Boiled Egg"],
    prepTime: "20 mins",
    isAvailable: true,
    category: "food",
    rating: 4.9,
  ...
  p1_5: {
    ...
    details: ["Slow-Grilled Goat Cuts", "Habanero Pepper Toss", "Fresh Diced Red Onions"],
    prepTime: "10-15 mins",
    isAvailable: true,
    category: "food",
    rating: 4.8,
  ...
  p1_6: {
    ...
    details: ["Sweet Ripe Plantain", "Golden Crispy Edges", "Freshly Fried"],
    prepTime: "5 mins",
    isAvailable: true,
    category: "food",
    rating: 4.8,
  ...
  p1_7: {
    ...
    details: ["Fresh Shredded Cabbage", "Sweet Corn & Carrots", "Creamy Dressing"],
    prepTime: "5 mins",
    isAvailable: true,
    category: "food",
    rating: 4.7,
