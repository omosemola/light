...
const VENDORS_DATA: Record<string, {
  ...
  v5: {
    id: "v5",
    name: "Campus Bites",
    category: "Burgers, Fries & Quick Bites",
    rating: 4.7,
    reviewsCount: 88,
    location: "Zik Hall Cafeteria",
    prepTime: "15 mins",
    isOpen: true,
    ...
    description: "Crispy chicken burgers, loaded fries, hot dogs, and quick bites delivered hot to your hostel.",
    phone: "+234 814 888 9911",
    ordersCount: 890,
    products: [
      {
        id: "f4",
  ...
  v7: {
    ...
    rating: 4.7,
    reviewsCount: 34,
    location: "Bello Hall Commercial Block",
    prepTime: "10 mins",
    isOpen: true,
    avatar: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&w=300&q=80",
    coverImage: "https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=1200&q=80",
    description: "Bulk hostel provisions, noodles, canned goods, cooking oils, and daily student groceries.",
  ...
  v8: {
    id: "v8",
    name: "Tasty Bakes",
    category: "Pastries & Fresh Bakery",
    rating: 4.9,
    reviewsCount: 145,
    location: "Kuti Hall Gate Annex",
    prepTime: "5 mins",
    isOpen: true,
    ...
    description: "Freshly baked meat pies, sausage rolls, donuts, custom birthday cakes, and warm bread daily.",
  ...
  v9: {
    ...
    rating: 4.8,
    reviewsCount: 29,
    location: "Health Center Square",
    prepTime: "10 mins",
    isOpen: true,
    avatar: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=300&q=80",
    coverImage: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=1200&q=80",
    description: "Certified skincare, soaps, lotions, oral care, and student personal hygiene items.",
