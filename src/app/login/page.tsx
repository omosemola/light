    ...
    <div className="min-h-screen w-full bg-[#FAFAF7] text-[#18181B] font-body flex flex-col justify-between p-6 md:p-10 selection:bg-[#312E81] selection:text-white">
      ...
      <div className="max-w-md mx-auto w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-heading font-extrabold text-lg tracking-tight text-[#312E81] dark:text-indigo-300">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#71717A] mt-2">
            Log in to manage your orders, saved items, and campus profile.
          </p>
        </div>
